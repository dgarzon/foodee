...
class RecommendationsControllerTest < ActionController::TestCase
  ...
  test "should create recommendation" do
    assert_difference('Recommendation.count') do
      post :create, recommendation: { description: @recommendation.description, like: @recommendation.like, restaurant_id: @recommendation.restaurant_id, user_id: @recommendation.user_id }
    end
  ...
  test "should update recommendation" do
    patch :update, id: @recommendation, recommendation: { description: @recommendation.description, like: @recommendation.like, restaurant_id: @recommendation.restaurant_id, user_id: @recommendation.user_id }
    assert_redirected_to recommendation_path(assigns(:recommendation))
  end
